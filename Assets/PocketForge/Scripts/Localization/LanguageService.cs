...
namespace PocketForge.Localization
{
    ...
    public static class LanguageService
    {
        ...
        private static readonly Dictionary<SupportedLanguage, Dictionary<string, string>> Tables = new()
        {
            ...
            {
                ["commerce_title"] = "상점과 이벤트", ["shop_summary"] = "오늘의 보급품과 성장 상품", ["shop_refresh_in"] = "무료 상품 갱신까지 {0}",
                ["shop_daily_supply"] = "일일 보급 상자", ["shop_daily_supply_desc"] = "매일 한 번 무료 보상",
                ["shop_rewarded_supply"] = "광고 보급 상자", ["shop_rewarded_supply_desc"] = "광고 시청 후 추가 크레딧",
                ["shop_credit_crate"] = "크레딧 상자", ["shop_credit_crate_desc"] = "Gem을 크레딧으로 교환",
                ["shop_core_crate"] = "코어 상자", ["shop_core_crate_desc"] = "Gem을 설계도 코어로 교환",
                ["shop_remove_ads_desc"] = "전면 광고를 영구 제거", ["shop_starter_pack"] = "스타터 패키지",
                ["shop_starter_pack_desc"] = "초반 성장을 돕는 1회 패키지", ["shop_permanent"] = "영구 적용",
                ["shop_locked"] = "상점은 광부 Lv. 6에 해금됩니다", ["events_locked"] = "이벤트는 광부 Lv. 7에 해금됩니다",
                ["shop_daily_limit"] = "오늘 받을 수 있는 횟수를 모두 사용했습니다", ["shop_unavailable"] = "상품을 이용할 수 없습니다",
                ["not_enough_gems"] = "Gem이 부족합니다", ["free"] = "무료", ["claimed"] = "수령 완료", ["owned"] = "보유 중",
                ["buy"] = "구매", ["watch_ad"] = "광고 보기", ["unavailable"] = "준비 중",
                ["event_crystal_rush"] = "수정 러시", ["event_crystal_rush_desc"] = "광석 5개마다 이벤트 토큰 1개 획득",
                ["event_tokens"] = "토큰", ["event_ends_in"] = "종료까지 {0}", ["event_tier_title"] = "토큰 {0} 누적 보상",
                ["event_exchange"] = "이벤트 교환", ["event_exchange_limit"] = "교환 {0}/{1}", ["exchange"] = "교환",
                ["event_unavailable"] = "진행 중인 이벤트가 없습니다", ["event_reward_locked"] = "필요한 토큰을 아직 모으지 못했습니다",
                ["event_not_enough_tokens"] = "이벤트 토큰이 부족합니다", ["event_exchange_limit_reached"] = "이번 이벤트의 교환 한도에 도달했습니다",
                ["daily"] = "\uC77C\uC77C", ["weekly"] = "\uC8FC\uAC04",
                ...
                ["blueprint_core"] = "\uC124\uACC4\uB3C4 \uCF54\uC5B4", ["blueprint_core_short"] = "\uCF54\uC5B4", ["blueprint_cores"] = "\uC124\uACC4\uB3C4 \uCF54\uC5B4 {0}",
            ...
            {
                ["commerce_title"] = "Shop & Events", ["shop_summary"] = "Daily supplies and growth offers", ["shop_refresh_in"] = "Free refresh in {0}",
                ["shop_daily_supply"] = "Daily Supply", ["shop_daily_supply_desc"] = "One free reward every day",
                ["shop_rewarded_supply"] = "Ad Supply", ["shop_rewarded_supply_desc"] = "Watch an ad for extra Credits",
                ["shop_credit_crate"] = "Credit Crate", ["shop_credit_crate_desc"] = "Exchange Gems for Credits",
                ["shop_core_crate"] = "Core Crate", ["shop_core_crate_desc"] = "Exchange Gems for Blueprint Cores",
                ["shop_remove_ads_desc"] = "Permanently removes interstitial ads", ["shop_starter_pack"] = "Starter Pack",
                ["shop_starter_pack_desc"] = "One-time early progression bundle", ["shop_permanent"] = "Permanent",
                ["shop_locked"] = "Shop unlocks at Miner Lv. 6", ["events_locked"] = "Events unlock at Miner Lv. 7",
                ["shop_daily_limit"] = "Today's claim limit has been reached", ["shop_unavailable"] = "Product unavailable",
                ["not_enough_gems"] = "Not enough Gems", ["free"] = "Free", ["claimed"] = "Claimed", ["owned"] = "Owned",
                ["buy"] = "Buy", ["watch_ad"] = "Watch Ad", ["unavailable"] = "Unavailable",
                ["event_crystal_rush"] = "Crystal Rush", ["event_crystal_rush_desc"] = "Earn 1 event token for every 5 ores",
                ["event_tokens"] = "Tokens", ["event_ends_in"] = "Ends in {0}", ["event_tier_title"] = "Earn {0} Tokens",
                ["event_exchange"] = "Event Exchange", ["event_exchange_limit"] = "Exchange {0}/{1}", ["exchange"] = "Exchange",
                ["event_unavailable"] = "No active event", ["event_reward_locked"] = "More event tokens are required",
                ["event_not_enough_tokens"] = "Not enough event tokens", ["event_exchange_limit_reached"] = "Event exchange limit reached",
                ...
                ["blueprint_core"] = "Blueprint Core", ["blueprint_core_short"] = "Core", ["blueprint_cores"] = "Blueprint Cores {0}",
            ...
            {
                ["commerce_title"] = "ショップとイベント", ["shop_summary"] = "デイリー補給と成長商品", ["shop_refresh_in"] = "無料更新まで {0}",
                ["shop_daily_supply"] = "デイリー補給", ["shop_daily_supply_desc"] = "毎日1回無料報酬",
                ["shop_rewarded_supply"] = "広告補給", ["shop_rewarded_supply_desc"] = "広告視聴で追加クレジット",
                ["shop_credit_crate"] = "クレジット箱", ["shop_credit_crate_desc"] = "ジェムをクレジットに交換",
                ["shop_core_crate"] = "コア箱", ["shop_core_crate_desc"] = "ジェムを設計コアに交換",
                ["shop_remove_ads_desc"] = "全画面広告を永久に削除", ["shop_starter_pack"] = "スターターパック",
                ["shop_starter_pack_desc"] = "序盤成長用の1回限定パック", ["shop_permanent"] = "永久適用",
                ["shop_locked"] = "ショップは鉱夫 Lv. 6 で解放", ["events_locked"] = "イベントは鉱夫 Lv. 7 で解放",
                ["shop_daily_limit"] = "本日の受取上限に達しました", ["shop_unavailable"] = "商品を利用できません",
                ["not_enough_gems"] = "ジェムが足りません", ["free"] = "無料", ["claimed"] = "受取済み", ["owned"] = "所持済み",
                ["buy"] = "購入", ["watch_ad"] = "広告を見る", ["unavailable"] = "準備中",
                ["event_crystal_rush"] = "クリスタルラッシュ", ["event_crystal_rush_desc"] = "鉱石5個ごとにイベントトークン1個",
                ["event_tokens"] = "トークン", ["event_ends_in"] = "終了まで {0}", ["event_tier_title"] = "トークン {0} 累計報酬",
                ["event_exchange"] = "イベント交換", ["event_exchange_limit"] = "交換 {0}/{1}", ["exchange"] = "交換",
                ["event_unavailable"] = "開催中のイベントはありません", ["event_reward_locked"] = "必要なトークンが足りません",
                ["event_not_enough_tokens"] = "イベントトークンが足りません", ["event_exchange_limit_reached"] = "イベント交換上限に達しました",
                ...
                ["blueprint_core"] = "\u8A2D\u8A08\u30B3\u30A2", ["blueprint_core_short"] = "\u30B3\u30A2", ["blueprint_cores"] = "\u8A2D\u8A08\u30B3\u30A2 {0}",
            ...
            {
                ["commerce_title"] = "商店与活动", ["shop_summary"] = "每日补给与成长商品", ["shop_refresh_in"] = "免费刷新还有 {0}",
                ["shop_daily_supply"] = "每日补给", ["shop_daily_supply_desc"] = "每天一次免费奖励",
                ["shop_rewarded_supply"] = "广告补给", ["shop_rewarded_supply_desc"] = "观看广告获得额外金币",
                ["shop_credit_crate"] = "金币箱", ["shop_credit_crate_desc"] = "用宝石兑换金币",
                ["shop_core_crate"] = "核心箱", ["shop_core_crate_desc"] = "用宝石兑换蓝图核心",
                ["shop_remove_ads_desc"] = "永久移除插屏广告", ["shop_starter_pack"] = "新手礼包",
                ["shop_starter_pack_desc"] = "帮助前期成长的一次性礼包", ["shop_permanent"] = "永久生效",
                ["shop_locked"] = "商店在矿工 Lv. 6 解锁", ["events_locked"] = "活动在矿工 Lv. 7 解锁",
                ["shop_daily_limit"] = "今日领取次数已用完", ["shop_unavailable"] = "商品暂不可用",
                ["not_enough_gems"] = "宝石不足", ["free"] = "免费", ["claimed"] = "已领取", ["owned"] = "已拥有",
                ["buy"] = "购买", ["watch_ad"] = "观看广告", ["unavailable"] = "准备中",
                ["event_crystal_rush"] = "水晶冲刺", ["event_crystal_rush_desc"] = "每开采5个矿石获得1个活动代币",
                ["event_tokens"] = "代币", ["event_ends_in"] = "结束还有 {0}", ["event_tier_title"] = "累计 {0} 代币奖励",
                ["event_exchange"] = "活动兑换", ["event_exchange_limit"] = "兑换 {0}/{1}", ["exchange"] = "兑换",
                ["event_unavailable"] = "当前没有活动", ["event_reward_locked"] = "活动代币尚未达到要求",
                ["event_not_enough_tokens"] = "活动代币不足", ["event_exchange_limit_reached"] = "已达到本次活动兑换上限",
                ["daily"] = "\u6BCF\u65E5", ["weekly"] = "\u6BCF\u5468",
                ...
                ["blueprint_core"] = "\u84DD\u56FE\u6838\u5FC3", ["blueprint_core_short"] = "\u6838\u5FC3", ["blueprint_cores"] = "\u84DD\u56FE\u6838\u5FC3 {0}",
        ...
        private static string GetCommerceText(string key)
        {
            return (Current, key) switch
            {
                ...
                (SupportedLanguage.Korean, "privacy_options") => "\uAD11\uACE0 \uB3D9\uC758 \uC124\uC815",
                ...
                (SupportedLanguage.Japanese, "privacy_options") => "\u5E83\u544A\u540C\u610F\u8A2D\u5B9A",
                ...
                (SupportedLanguage.ChineseSimplified, "privacy_options") => "\u5E7F\u544A\u540C\u610F\u8BBE\u7F6E",
                ...
                (_, "privacy_options") => "Ad privacy settings",
