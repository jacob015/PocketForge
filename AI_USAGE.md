...
| 2026-07-16 | Codex + Unity MCP | 다국어 기반 | Unity Localization 패키지, 네 언어 문자열 테이블, 기기 언어 기본값, 저장·즉시 갱신 서비스 | Unity 컴파일 오류 0건, EditMode 11/11 통과. 설정창은 후속 작업에서 서비스 API에 연결 | 완료 |
